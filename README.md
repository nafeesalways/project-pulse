...
📹 **Demo Video:** [https://drive.google.com/file/d/1ZSytzY-cj7AoD6qGhNUKx-35Kb8ax_p6/view?usp=sharing](https://drive.google.com/file/d/1ZSytzY-cj7AoD6qGhNUKx-35Kb8ax_p6/view?usp=sharing)
...
- **Low Confidence Penalty:** (5 - confidence) × 10 points
- **High Risk Penalty:** 15 points per open high-severity risk
- **Low Feedback Penalty:**
  - Rating 5: +5 bonus
  - Rating 4: No change
  - Rating 3: -10 points
...
- 1 Employee user (emp1@test.com / 123)
- 1 Client user (client1@test.com / 123)
...
│ │ │ ├── projects/
│ │ │ │ ├── route.js
│ │ │ │ ├── my-projects/route.js
│ │ │ │ └── client-projects/route.js
│ │ │ └── users/route.js
│ │ ├── dashboard/
│ │ │ ├── admin/page.js
│ │ │ ├── employee/page.js
